...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    @IBInspectable open var mentionColor: UIColor = ActiveLabelSetting.shared.mentionColor {
        didSet { updateTextStorage(parseText: false) }
    }
    @IBInspectable open var mentionSelectedColor: UIColor? {
        didSet { updateTextStorage(parseText: false) }
    }
    @IBInspectable open var hashtagColor: UIColor = ActiveLabelSetting.shared.hashtagColor {
        didSet { updateTextStorage(parseText: false) }
    }
    @IBInspectable open var hashtagSelectedColor: UIColor? {
        didSet { updateTextStorage(parseText: false) }
    }
    @IBInspectable open var URLColor: UIColor = ActiveLabelSetting.shared.urlColor {
        didSet { updateTextStorage(parseText: false) }
    }
